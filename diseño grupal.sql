<div class="col-md-12"><button id="pdfOrders" wg-action="JobOverViews" class="btn btn-p-1 ic-pdf-r w-25">Generate PDF</button></div>
<div class="col-md-12 px-5" id="content">
	...
	<div class="row" data-bind="foreach: wg.jobOverView">
		<div class="panel invoice-list col-3 border border-black lh-lg overflow-y-auto h-25">
			<h5 class="text-center mt-4"><strong>JOB INFORMATION</strong></h5>
			<hr>
			<div><strong>Description: <label data-bind="text: jobDescription"/></strong></div>
			<div><strong>Size: <label data-bind="text: ringSize"/></strong></div>
			<div><strong>Serial #: <label data-bind="text: jobNo"/></strong></div>
			<div><strong>Order type: <label data-bind="text: productionReason"/></strong></div>
			<div><strong>P.O.:</strong> <label data-bind="text: poNo" /></div>
			<div><strong>Article #:</strong> <label data-bind="text: referenceNo" /></div>
			<div><strong>Batch/Destination:</strong> <label data-bind="text: batch" /> <label data-bind="text: destinations" /></div>
			<div><strong>CPO:</strong> <label data-bind="text: cpoNo" /></div>
			<div><strong>SO:</strong> <label data-bind="text: soNo" /></div>
		</div>
		<div class="col-1 "></div>
		<div class="col-8 table-responsive-sm border border-black overflow-y-auto h-25 mb-5">
			<table class="table table-sm table-striped">
				...
				<tbody data-bind="foreach: laborCosts">
					<tr>
